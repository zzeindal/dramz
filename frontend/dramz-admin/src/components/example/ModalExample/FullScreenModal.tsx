...
export default function FullScreenModal() {
  ...
  return (
    <ComponentCard title="Full Screen Modal">
      ...
      >
        <div className="fixed top-0 left-0 flex flex-col justify-between w-full h-screen p-6 overflow-x-hidden overflow-y-auto bg-white dark:bg-[#0D0920] lg:p-10">
          <div>
            ...
            <p className="mt-5 text-sm leading-6 text-gray-500 dark:text-white">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              Pellentesque euismod est quis mauris lacinia pharetra. Sed a
              ligula ac odio condimentum aliquet a nec nulla. Aliquam bibendum
